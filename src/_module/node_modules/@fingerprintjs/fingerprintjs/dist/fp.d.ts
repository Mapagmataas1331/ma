 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getRawAudioFingerprint(): number | (() => Promise<number>);
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getRawCanvasFingerprint(skipImages?: boolean): Promise<CanvasFingerprint>;
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getRawScreenResolution(): ScreenResolution;
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getRawScreenFrame(): () => Promise<FrameSize>;
/**
 * A version of the entropy source with stabilization to make it suitable for static fingerprinting.
 *
 ...
 * This function is out of Semantic Versioning, i.e. can change unexpectedly. Usage is at your own risk.
 */
declare function getUTF8Bytes(input: string): Uint8Array;
...
export { Agent, BuiltinComponents, Component, Confidence, GetOptions, GetResult, LoadOptions, Source, SourcesToComponents, UnknownComponents, UnknownSources, componentsToDebugString, _default as default, getFullscreenElement, getRawAudioFingerprint, getRawCanvasFingerprint, getRawScreenFrame, getRawScreenResolution, getUTF8Bytes, getWebGLContext, getStateFromError as handleApplePayError, hashComponents, isAndroid, isChromium, isDesktopWebKit, isEdgeHTML, isGecko, isTrident, isWebKit, load, loadSources, murmurX64Hash128, prepareForSources, sources, transformSource, withIframe };
